...
class InferenceScript:
    ...
    def _sample_decoder(
        ...
        text: List[str] = None, text_encoding: List[torch.Tensor] = None, cond_images: List[PILImage.Image] = None,
        ...
        start_at_unet_number=1, start_diffusion_step=0, lowres_noise_level=1000, base_noise_level=1,
    ):
        """
        ...
        with self._decoder_in_gpu() as decoder:
            for i in range(len(image_embeddings)):
                args = {}
                embeddings_map = []
                args['start_at_unet_number'] = start_at_unet_number
                args['image'] = cond_images[i]
                args['start_diffusion_step'] = start_diffusion_step
                args['noise_level'] = lowres_noise_level
                args['base_noise_level'] = base_noise_level
